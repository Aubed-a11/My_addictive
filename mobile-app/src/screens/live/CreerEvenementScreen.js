...
export default function CreerEvenementScreen({ navigation }) {
  ...
  const creer = async () => {
    ...
    try {
      ...
      setMessage('Événement cree ! Retrouvez-le dans la liste des événements a venir.');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <View style={{ padding: 20 }}>
        ...
        <TextField label="Titre de l'événement" value={titre} onChangeText={setTitre} placeholder="Ex. Nuit Afrobeat" />
        ...
        <PrimaryButton titre="Creer l'événement" onPress={creer} couleur={COLORS.billetterie} chargement={chargement} />
