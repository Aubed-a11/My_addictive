...
const LIBELLES_STATUT = {
  ...
  UTILISE: { texte: 'Déjà scanne a l\u2019entree', couleur: '#F87171' },
          ...
          return (
            <View style={styles.carte}>
              ...
              <Text style={styles.instruction}>
                Presentez ce code QR a l'entrée : un agent le scannera avec l'application organisateur pour valider votre acces. Chaque billet ne peut etre scanne qu'une seule fois.
              </Text>
            </View>
          );
        }}
