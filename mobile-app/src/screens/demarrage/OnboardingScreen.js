...
const TUILES_HUB = [
  { titre: 'Media', sousTitre: 'Actualites & vidéos', Icone: Newspaper, couleur: COLORS.media },
  { titre: 'Musique', sousTitre: 'Ecoutez & telechargez', Icone: Music, couleur: COLORS.musique },
  { titre: 'Billetterie', sousTitre: 'Concerts & événements', Icone: Ticket, couleur: COLORS.billetterie },
...
const PAGES = [
  {
    ...
    texte: 'La plateforme tout-en-un dediee a la musique, aux événements, aux artistes et a vous.',
  ...
  },
  {
    ...
    texte: 'Actualites, musique, événements, votes et boutique.',
    grille: true,
  ...
  },
  {
    ...
    texte: 'Rejoignez la communaute, participez aux événements et faites entendre votre voix.',
